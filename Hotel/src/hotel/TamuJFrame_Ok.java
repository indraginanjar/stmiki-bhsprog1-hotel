...
public class TamuJFrame_Ok extends javax.swing.JFrame {
    ...
    private void refreshTable(){
        try{
            this.tamuResultSet.afterLast();
            int rowCount = 0;
            if(this.tamuResultSet.previous()){
                rowCount = this.tamuResultSet.getRow();
            }
            String rowData[][] = new String[rowCount][5];
            this.tamuResultSet.beforeFirst();
            int rowNum = 0;
            while(this.tamuResultSet.next()){
                rowData[rowNum][0] = this.tamuResultSet.getString(1);
                rowData[rowNum][1] = this.tamuResultSet.getString(2);
                rowData[rowNum][2] = this.tamuResultSet.getString(3);
              
                ++rowNum;
            }
            this.tamuScrollPane.getViewport().remove(this.tamuTable);
            this.tamuTable = null;
            this.tamuTable = new javax.swing.JTable(rowData, this.columnNames);
            ...
            this.tamuScrollPane.getViewport().add(this.tamuTable);
        }catch(java.sql.SQLException e){
            System.out.println(e.getMessage());
        }
    }
    ...
    private void tamuTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tamuTableMouseClicked
        ...
        if(rowNum != -1){
            javax.swing.table.TableModel model = this.tamuTable.getModel();
            this.idTextField.setText((String) model.getValueAt(rowNum, 0));
            this.tamuTextField.setText((String) model.getValueAt(rowNum, 1));
            this.kamarTextField.setText((String) model.getValueAt(rowNum, 2));
            try{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TamuJFrame_Ok().setVisible(true);
            }
        });
    }
